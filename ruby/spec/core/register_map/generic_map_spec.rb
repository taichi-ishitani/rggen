    ...
    describe "#[]" do
      context "引数がシート名のとき" do
        it "シート名が'sheet'のシートオブジェクトを返す" do
          ...
          expect(sheet).to be_kind_of(GenericMap::Sheet).and have_attributes(name: sheet_name)
        end
        ...
        context "当該のシートがない場合" do
          it "新たにシートオブジェクトを追加する" do
            ...
            expect(map.sheets).to match sheets
          end
        end
