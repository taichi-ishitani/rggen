  ...
  describe "#model_creation" do
    ...
    let(:expected_code) do
      [
        ...
        "`rggen_ral_create_field_model(bit_field_4_0, \"bit_field_4_0\", 1, 1, \"RWL\", 0, 1'h0, 1, \"u_bit_field_4_0.value\")\n",
        "`rggen_ral_create_field_model(bit_field_4_1, \"bit_field_4_1\", 1, 0, \"RWE\", 0, 1'h0, 1, \"u_bit_field_4_1.value\")\n",
        "`rggen_ral_create_field_model(bit_field_5_0, \"bit_field_5_0\", 1, 1, \"RW\", 0, 1'h0, 1, \"u_bit_field_5_0.value\")\n",
        "`rggen_ral_create_field_model(bit_field_5_1, \"bit_field_5_1\", 1, 0, \"RW\", 0, 1'h0, 1, \"u_bit_field_5_1.value\")\n"
      ].join
    end
