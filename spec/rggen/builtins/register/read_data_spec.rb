  ...
  before(:all) do
    ...
    register_map  = create_register_map(
      ...
      "block_0" => [
        ...
        [nil, nil         , nil                                                                                                         ],
        [nil, nil         , nil                                                                                                         ],
        [nil, "register_0", "0x00"     , nil     , nil                                     , "bit_field_0_0", "[31:16]", "rw"      , 0  ],
        [nil, nil         , nil        , nil     , nil                                     , "bit_field_0_1", "[15: 0]", "ro"      , nil],
        [nil, "register_1", "0x04"     , nil     , nil                                     , "bit_field_1_0", "[ 7: 0]", "rw"      , 0  ],
        ...
        [nil, nil         , nil        , nil     , nil                                     , "bit_field_2_3", "[ 7: 0]", "rw"      , 0  ],
        ...
        [nil, nil         , nil        , nil     , nil                                     , "bit_field_3_3", "[31:24]", "rw"      , 0  ],
        ...
        [nil, nil         , nil        , nil     , nil                                     , "bit_field_4_3", "[ 7: 0]", "rw"      , 0  ],
        [nil, "register_5", "0x14-0x1B", "[2]"   , nil                                     , "bit_field_5_0", "[31:16]", "rw"      , 0  ],
        [nil, nil         , nil        , nil     , nil                                     , "bit_field_5_1", "[15:0]" , "ro"      , nil],
        [nil, "regsiter_6", "0x1C"     , "[2, 4]", "indirect: bit_field_0_0, bit_field_0_1", "bit_field_6_0", "[31:16]", "ro"      , nil],
        [nil, nil         , nil        , nil     , nil                                     , "bit_field_6_1", "[15:0]" , "rw"      , 0  ],
        [nil, "register_7", "0x20"     , nil     , nil                                     , "bit_field_7_0", "[31:16]", "wo"      , nil],
        [nil, nil         , nil        , nil     , nil                                     , "bit_field_7_1", "[15: 0]", "reserved", nil],
        [nil, "register_8", "0x24-0x2F", nil     , :external                               , nil            , nil      , nil       , nil]
      ]
    )
