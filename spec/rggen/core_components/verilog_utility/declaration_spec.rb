...
module RgGen::VerilogUtility
  describe Declaration do
    ...
    it "変数宣言を行うコードを生成する" do
      ...
      expect(variable_declaration(name: "foo", data_type: :logic, width: nil  , vector: true                                        )).to eq "logic [0:0] foo"
      expect(variable_declaration(name: "foo", data_type: :logic, width: nil  , vector: false                                       )).to eq "logic foo"
      expect(variable_declaration(name: "foo", data_type: :logic, width: 1                                                          )).to eq "logic foo"
      expect(variable_declaration(name: "foo", data_type: :logic, width: 1    , vector: true                                        )).to eq "logic [0:0] foo"
      expect(variable_declaration(name: "foo", data_type: :logic, width: 1    , vector: false                                       )).to eq "logic foo"
      ...
      expect(variable_declaration(name: "foo", data_type: :logic, width: width                                                      )).to eq "logic [WIDTH-1:0] foo"
      expect(variable_declaration(name: "foo", data_type: :logic, width: width, vector: false                                       )).to eq "logic [WIDTH-1:0] foo"
    end
    ...
    it "ポート宣言を行うコードを生成する" do
      ...
      expect(port_declaration(name: "foo", direction: :output,                    width: nil  , vector: true      )).to eq "output [0:0] foo"
      expect(port_declaration(name: "foo", direction: :output,                    width: nil  , vector: false     )).to eq "output foo"
      expect(port_declaration(name: "foo", direction: :output,                    width: 1                        )).to eq "output foo"
      expect(port_declaration(name: "foo", direction: :output,                    width: 1    , vector: true      )).to eq "output [0:0] foo"
      expect(port_declaration(name: "foo", direction: :output,                    width: 1    , vector: false     )).to eq "output foo"
      ...
      expect(port_declaration(name: "foo", direction: :output,                    width: width                    )).to eq "output [WIDTH-1:0] foo"
      expect(port_declaration(name: "foo", direction: :output,                    width: width, vector: false     )).to eq "output [WIDTH-1:0] foo"
    end
    ...
    it "パラメータ宣言を行うコードを生成する" do
      ...
      expect(parameter_declaration(name: "FOO", parameter_type: :parameter ,                    width: nil   , vector: true,      default: 0              )).to eq "parameter [0:0] FOO = 0"
      ...
      expect(parameter_declaration(name: "FOO", parameter_type: :parameter ,                    width: width,                     default: 0              )).to eq "parameter [WIDTH-1:0] FOO = 0"
    end
  end
end
