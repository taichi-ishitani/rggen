...
describe "register/read_data" do
  ...
  before(:all) do
    ...
    RGen.enable(:register, [:name, :offset_address, :array, :accessibility])
    ...
    register_map  = create_register_map(
      ...
      "block_0" => [
        ...
        [nil, nil         , nil                                                            ],
        [nil, nil         , nil                                                            ],
        [nil, "register_0", "0x00"     , nil  , "bit_field_0_0", "[31:16]", "rw"      , nil],
        [nil, nil         , nil        , nil  , "bit_field_0_1", "[15: 0]", "ro"      , nil],
        [nil, "register_1", "0x04"     , nil  , "bit_field_1_0", "[ 7: 0]", "rw"      , nil],
        [nil, nil         , nil        , nil  , "bit_field_1_1", "[23:16]", "ro"      , nil],
        [nil, "register_2", "0x08"     , nil  , "bit_field_2_0", "[31:24]", "reserved", nil],
        [nil, nil         , nil        , nil  , "bit_field_2_1", "[23:16]", "ro"      , nil],
        [nil, nil         , nil        , nil  , "bit_field_2_2", "[15: 8]", "wo"      , nil],
        [nil, nil         , nil        , nil  , "bit_field_2_3", "[ 7: 0]", "rw"      , nil],
        [nil, "register_3", "0x0C"     , nil  , "bit_field_3_0", "[ 7: 0]", "reserved", nil],
        [nil, nil         , nil        , nil  , "bit_field_3_1", "[15: 8]", "ro"      , nil],
        [nil, nil         , nil        , nil  , "bit_field_3_2", "[23:16]", "wo"      , nil],
        [nil, nil         , nil        , nil  , "bit_field_3_3", "[31:24]", "rw"      , nil],
        [nil, "register_4", "0x10"     , nil  , "bit_field_4_0", "[31:24]", "ro"      , nil],
        [nil, nil         , nil        , nil  , "bit_field_4_1", "[23:20]", "reserved", nil],
        [nil, nil         , nil        , nil  , "bit_field_4_2", "[11: 8]", "wo"      , nil],
        [nil, nil         , nil        , nil  , "bit_field_4_3", "[ 7: 0]", "rw"      , nil],
        [nil, "register_5", "0x14-0x1B", "[2]", "bit_field_5_0", "[31:16]", "rw"      , nil],
        [nil, nil         , nil        , nil  , "bit_field_5_1", "[15:0]" , "ro"      , nil],
        [nil, "register_6", "0x1C"     , nil  , "bit_field_6_0", "[31:16]", "wo"      , nil],
        [nil, nil         , nil        , nil  , "bit_field_6_1", "[15: 0]", "reserved", nil]
      ]
    )
