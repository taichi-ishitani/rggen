  ...
  before(:all) do
    ...
    register_map  = create_register_map(
      ...
      "block_0" => [
        ...
        [nil, nil         , nil                                        ],
        [nil, nil         , nil                                        ],
        [nil, "register_0", "bit_field_0_0", "[31:16]", "rw"      , nil],
        [nil, nil         , "bit_field_0_1", "[15: 0]", "ro"      , nil],
        [nil, "register_1", "bit_field_1_0", "[ 7: 0]", "rw"      , nil],
        [nil, nil         , "bit_field_1_1", "[23:16]", "ro"      , nil],
        [nil, "register_2", "bit_field_2_0", "[31:24]", "reserved", nil],
        [nil, nil         , "bit_field_2_1", "[23:16]", "ro"      , nil],
        [nil, nil         , "bit_field_2_2", "[15: 8]", "wo"      , nil],
        [nil, nil         , "bit_field_2_3", "[ 7: 0]", "rw"      , nil],
        [nil, "register_3", "bit_field_3_0", "[ 7: 0]", "reserved", nil],
        [nil, nil         , "bit_field_3_1", "[15: 8]", "ro"      , nil],
        [nil, nil         , "bit_field_3_2", "[23:16]", "wo"      , nil],
        [nil, nil         , "bit_field_3_3", "[31:24]", "rw"      , nil],
        [nil, "register_4", "bit_field_4_0", "[31:24]", "ro"      , nil],
        [nil, nil         , "bit_field_4_1", "[23:20]", "reserved", nil],
        [nil, nil         , "bit_field_4_2", "[11: 8]", "wo"      , nil],
        [nil, nil         , "bit_field_4_3", "[ 7: 0]", "rw"      , nil],
        [nil, "register_5", "bit_field_5_0", "[31:16]", "wo"      , nil],
        [nil, nil         , "bit_field_5_1", "[15: 0]", "reserved", nil]
      ]
    )
  ...
  describe "#generate_code" do
    ...
    context "レジスタ内に読み出し可能なビットフィールドが無い場合" do
      it "ダミーの読み出しデータとして0を返すコードを生成する" do
        expect(rtl[5]).to generate_code(:module_item, :top_down, "assign register_read_data[5] = 32'h00000000;\n")
      end
    end
  end
end
