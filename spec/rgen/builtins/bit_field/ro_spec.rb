...
describe 'bit_fields/type/ro' do
  ...
  describe "#rtl" do
    before(:all) do
      register_map  = create_register_map(
        ...
        "block_0" => [
          ...
          [nil, nil, nil                                           ],
          [nil, nil, nil                                           ],
          [nil, 'register_0', 'bit_field_0_0', "[31:0]" , "ro", nil],
          [nil, 'register_1', 'bit_field_1_0', "[31:16]", "ro", nil],
    ...
    it "入力ポートvalue_inを持つ" do
      expect(rtl[0]).to have_input(:value_in, name: "i_bit_field_0_0", width: 32)
    ...
    describe "#generate_code" do
      it "#valueと#value_inを接続するコードを生成する" do
        expect(rtl[0]).to generate_code(:module_item, :top_down, "assign bit_field_0_0_value = i_bit_field_0_0;\n")
